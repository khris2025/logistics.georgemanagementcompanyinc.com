...
<section class="content-section">
   <div class="container">
      <div class="row">
         ...
         <!-- end col-12 -->
         <div class="col-lg-6">
            <p>GEORGE_MGT COMP LOGISTICS.com, we believe the supplier-vendor relationship to be an
      ...
      <div class="row align-items-center no-gutters">
         <div class="col-lg-6">
            <div class="side-content">
               ...
               <p>GEORGE_MGT COMP LOGISTICS.com, we’re passionate about helping our
