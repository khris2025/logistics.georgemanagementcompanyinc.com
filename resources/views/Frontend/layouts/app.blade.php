...
<html lang="en">
   ...
   <head>
      ...
      <title>GEORGE_MGT COMP LOGISTICS
   ...
   <body>
         ...
         <div class="inner">
            ...
            <div class="hide-mobile">
               ...
               <address class="address">
                  <!-- <p>+1 (850) 344 0 66<br> -->
                  <a href="#">support@logistics.georgemanagementcompanyinc.com</a></p>
               </address>
            ...
            <!-- end show-mobile -->
            <small>© 2023 GEORGE_MGT COMP LOGISTICS
      ...
      <div class="topbar">
         <div class="container">
            ...
            <!-- end phone -->
            <div class="email"> Email: <a href="#">support@logistics.georgemanagementcompanyinc.com</a> </div>
            <!-- end email -->
      ...
      <footer class="footer">
         <div class="container">
            <div class="row">
               ...
               <!-- end col-4 -->
               <div class="col-12">
                  <div class="footer-bottom"> <span>© 2025 GEORGE_MGT COMP LOGISTICS| Logicstic Shipping Company</span> </div>
                  <!-- end footer-bottom -->
               </div>
               <!-- end col-12 -->
            </div>
